...
class SubtitleExtractor:
    ...
    """
    def __init__(self, video_path: str, raw_subtitle_path: str = None, status_path: str = None, detected_areas: dict = None):
        self.video_path = video_path
    ...
    def _extract_subtitles_with_area_detection(self, status_path: str = None):
        ...
        all_boxes = []
        for frame_box in self.detected_areas.values():
        ...
        sorted_frames = sorted(self.detected_areas.keys())
