...
class SubtitleExtractor:
    ...
    """
    def __init__(self, video_path: str, raw_subtitle_path: str = None, status_path: str = None):
        self.video_path = video_path
    ...
    def _extract_subtitles_with_area_detection(self, status_path: str = None):
        ...
        """
        print("Performing subtitle area detection...")
        subtitle_detect = SubtitleDetect(video_path=self.video_path)
        ...
        if not subtitle_frame_no_box_dict:
            print("No subtitles found after initial detection.")
            return ""
        ...
        correct_subtitle_frame_no_box_dict = subtitle_detect.filter_mistake_sub_area(
